...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '9710ce8e0b354632a2017338925fceba',
  ...
  AUTHOR: 'ℱ', // 作者
  BIO: '懒猫猫', // 作者简介
  LINK: 'https://no.fluorite.one', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'ℱ', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE: './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '现世为梦，夜梦为真。', // 站点描述，被notion中的页面描述覆盖
